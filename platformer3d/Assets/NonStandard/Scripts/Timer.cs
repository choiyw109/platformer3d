...
namespace NonStandard
{
	...
	public class Timer : MonoBehaviour
	{
		...
		public void CreateMainTimer() {
			...
			if (found == null) {
				...
				Debug.LogWarning("will not create another MainTimer, one already at " + found.transform.HierarchyPath());
			}
		}
#endif
	}
	...
	public class Chrono
	{
		...
		private float leftOverTime = 0; // TODO remove this by using C# system time instead of Unity Time.deltaTime?
		...
		public static Chrono Instance { get { return (s_instance != null) ? s_instance : s_instance = new Chrono(); } }
		...
		public void LinkedToMainThreadCheck() {
			if (linkedToMainThread == null) {
				string extraMessage = "";
#if UNITY_5_3_OR_NEWER
				extraMessage = "Create a Timer or MainTimer.Instance()";
#endif
